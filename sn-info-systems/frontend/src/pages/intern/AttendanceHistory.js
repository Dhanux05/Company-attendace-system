...
import { FiArrowLeft, FiCalendar, FiCheckCircle, FiXCircle, FiBarChart2 } from "react-icons/fi";
...
const AttendanceHistory = () => {
  ...
  return (
    <div className="page">
      <button type="button" className="page-back-btn" onClick={goBack} aria-label="Go back">
        <FiArrowLeft />
        <span>Back</span>
      </button>
      <div className="sub-nav sub-nav-center">
        <NavLink to="/intern/dashboard" className={({ isActive }) => `sub-nav-link ${isActive ? "active" : ""}`}>
          Dashboard
        </NavLink>
        <NavLink to="/intern/attendance" className={({ isActive }) => `sub-nav-link ${isActive ? "active" : ""}`}>
          Attendance
        </NavLink>
        <NavLink to="/intern/leave" className={({ isActive }) => `sub-nav-link ${isActive ? "active" : ""}`}>
          Leave
        </NavLink>
        <NavLink to="/intern/attendance-history" className={({ isActive }) => `sub-nav-link ${isActive ? "active" : ""}`}>
          Attendance History
        </NavLink>
        <NavLink to="/intern/leave-history" className={({ isActive }) => `sub-nav-link ${isActive ? "active" : ""}`}>
          Leave History
        </NavLink>
      </div>
