        ...
        <section className="analytics-panel panel-donut">
          ...
          <ResponsiveContainer width="100%" height={250}>
            <AreaChart data={leaveData} margin={{ left: 6, right: 12, top: 8, bottom: 0 }}>
              <defs>
                <linearGradient id="leaveDistFillPortal" x1="0" y1="0" x2="0" y2="1">
              ...
              <Tooltip contentStyle={TOOLTIP_STYLE} labelStyle={TOOLTIP_LABEL_STYLE} itemStyle={TOOLTIP_ITEM_STYLE} />
              <Area type="monotone" dataKey="value" name="Leaves" stroke="#22d3ee" fill="url(#leaveDistFillPortal)" strokeWidth={2.3} />
            </AreaChart>
          </ResponsiveContainer>
        </section>
